        ...
        <flux:sidebar sticky collapsible="mobile" class="border-e border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900">
            ...
            <flux:sidebar.nav>
                <flux:sidebar.group :heading="__('Menu Utama')" class="grid">
                    ...
                    <flux:sidebar.item icon="camera" :href="route('receipt-scanner')" :current="request()->routeIs('receipt-scanner')" wire:navigate>
                        {{ __('Scan Struk') }}
                    </flux:sidebar.item>
                </flux:sidebar.group>

                <flux:sidebar.group :heading="__('Kelola')" class="grid">
                    <flux:sidebar.item icon="chart-bar" :href="route('budgets')" :current="request()->routeIs('budgets')" wire:navigate>
                        {{ __('Anggaran') }}
                    </flux:sidebar.item>
